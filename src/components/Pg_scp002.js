...
import scp_image from "../images/scp_images/scp_002_image.jpg"
...
const scpSubject = 0;
class Pg_scp002 extends Component
{
    render()
    {
        return(
            <div>
                ...
                {breakercode}  
                <img className="imageContain" src={scp_image} alt="SCP-002"></img>
                {breakercode}
